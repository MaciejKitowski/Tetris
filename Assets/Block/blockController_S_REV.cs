...
public class blockController_S_REV : blockController
{
    ...
    {
        if ((actitveRotation == rotation.DOWN || actitveRotation == rotation.RIGHT) && tile[3].arenaTile.posX < 9) moveTilesHorizontal(1);
        else if ((actitveRotation == rotation.UP || actitveRotation == rotation.LEFT) && tile[0].arenaTile.posX < 9) moveTilesHorizontal(1);
    }
    ...
    override public void fallDown()
    {
        ...
        else if (actitveRotation == rotation.RIGHT && tile[0].arenaTile.posY < 19 && managerArena.tile[tile[0].arenaTile.posX, tile[0].arenaTile.posY + 1].isEmpty
