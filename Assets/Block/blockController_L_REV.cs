...
public class blockController_L_REV : blockController
{
    ...
    {
        if ((actitveRotation == rotation.DOWN || actitveRotation == rotation.RIGHT) && tile[0].arenaTile.posX > 0) moveTilesHorizontal(-1);
        else if (actitveRotation == rotation.UP && tile[1].arenaTile.posX > 0) moveTilesHorizontal(-1);
        else if (actitveRotation == rotation.LEFT && tile[3].arenaTile.posX > 0) moveTilesHorizontal(-1);
    }

    override public void turnRight()
    {
        if ((actitveRotation == rotation.DOWN || actitveRotation == rotation.LEFT) && tile[1].arenaTile.posX < 9) moveTilesHorizontal(1);
        else if (actitveRotation == rotation.RIGHT && tile[3].arenaTile.posX < 9) moveTilesHorizontal(1);
        else if (actitveRotation == rotation.UP && tile[0].arenaTile.posX < 9) moveTilesHorizontal(1);
    }
    ...
    override public void fallDown()
    {
        ...
        else if (actitveRotation == rotation.RIGHT && tile[0].arenaTile.posY < 19 && managerArena.tile[tile[2].arenaTile.posX, tile[2].arenaTile.posY + 1].isEmpty
        ...
        else if (actitveRotation == rotation.LEFT && tile[3].arenaTile.posY < 19 && managerArena.tile[tile[1].arenaTile.posX, tile[1].arenaTile.posY + 1].isEmpty
