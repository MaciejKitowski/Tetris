...
public class blockControllerT : MonoBehaviour
{
    ...
    {
        //Down - set to right
        if(tile[0].arenaTile.posY < tile[1].arenaTile.posY && tile[0].arenaTile.posX < 9)
        {
            ...
            tile[3].transform.position = managerArena.tile[tile[0].arenaTile.posX + 1, tile[0].arenaTile.posY - 1].transform.position;
        }
        ...
        //Up - set to left
        if (tile[0].arenaTile.posY > tile[1].arenaTile.posY && tile[0].arenaTile.posX > 0)
        {
        ...
        //Left - set to down
        if (tile[0].arenaTile.posX > tile[1].arenaTile.posX && tile[0].arenaTile.posX < 9)
        {
