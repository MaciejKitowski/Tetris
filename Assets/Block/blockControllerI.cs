...
public class blockControllerI : MonoBehaviour
{
    ...
    {
        if (actitveRotation == rotation.DOWN || actitveRotation == rotation.RIGHT || actitveRotation == rotation.UP)
        {
    ...
    {
        if (actitveRotation == rotation.DOWN || actitveRotation == rotation.LEFT || actitveRotation == rotation.UP)
        {
