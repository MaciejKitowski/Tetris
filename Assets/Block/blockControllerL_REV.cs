...
public class blockControllerL_REV : MonoBehaviour
{
    ...
    {
        //Down - set to right
        if (tile[0].arenaTile.posX < tile[1].arenaTile.posX && tile[0].arenaTile.posX < 8)
        {
        ...
        //Right - set to up
        if (tile[0].arenaTile.posY > tile[1].arenaTile.posY && tile[0].arenaTile.posY > 1)
        {
        ...
        //Up - set to left
        if (tile[0].arenaTile.posX > tile[1].arenaTile.posX && tile[0].arenaTile.posX > 1)
        {
        ...
        //Left - set to down
        if (tile[0].arenaTile.posY < tile[1].arenaTile.posY && tile[0].arenaTile.posY < 19)
        {
    ...
    {
        if(actitveRotation == rotation.DOWN || actitveRotation == rotation.RIGHT)
        {
    ...
    {
        if (actitveRotation == rotation.DOWN || actitveRotation == rotation.LEFT)
        {
